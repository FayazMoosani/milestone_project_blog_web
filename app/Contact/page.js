        ...
        <div className="bg-white shadow-lg rounded-lg p-8 md:p-12">
          ...
          <div className="text-lg text-gray-700 leading-relaxed">
            ...
            <div className="space-y-4 text-center">
              <p><strong>Phone:</strong> <a href="tel:+923181399799" className="text-blue-600 hover:underline">(+92) 318-1399799</a></p>
              <p><strong>Email:</strong> <a href="mailto:afayaz293@gmail.com" className="text-blue-600 hover:underline">afayaz293@gmail.com</a></p>
              <p><strong>Address:</strong> PNO/CVA House #948, Mehmudabad, Chanesar Goth, Karachi</p>
              <p><strong>Business Hours:</strong> Mon-Fri, 9am - 5pm</p>
            </div>
          </div>
          <div className="text-center mt-10">
            <a href="mailto:afayaz293@gmail.com" className="inline-block bg-blue-600 text-white text-lg font-semibold px-6 py-3 rounded-full shadow hover:bg-blue-700 transition">
              Contact Us Now
            </a>
          </div>
        </div>
